...
show_usage() {
    cat <<EOF
Usage:
  sh scripts/publish-zip.sh <article-name-or-zip> [zhihu-publisher args...]

Examples:
  sh scripts/publish-zip.sh AlexNet
  sh scripts/publish-zip.sh Resource/AlexNet.zip
  sh scripts/publish-zip.sh "Reading Research Papers and Career Advice from Andrew Ng" --compress
